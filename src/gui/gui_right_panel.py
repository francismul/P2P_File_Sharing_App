...
def create_right_panel(app_logic):
    widget = QWidget()
    ...
    files_tab = create_files_tab(app_logic)
    tabs.addTab(files_tab, "📁 Files")

    transfers_tab = create_transfers_tab(app_logic)
    tabs.addTab(transfers_tab, "📤 Transfers")

    chat_tab_widget, _ = create_chat_tab(app_logic)
    tabs.addTab(chat_tab_widget, "💬 Chat")
